...
<table id="tableBasicInfo">
   <tr>
      <td style="width:400px"><?php echo $this->Form->input('patient_id', array('type' => 'hidden', 'value' => $patient_id)); ?>
   ...
   <td>
      <div id="gender">
          <?php  
              ...
              echo $this->Form->input('gender',array('legend'=>false,'type'=>'radio','options'=>array('Male'=>'Male','Female'=>'Female'),'default'=>'Male'));   
         ?>
    </div>
   </td>   
   </tr>
   ...
   <tr>
      ...
      <td style="width:400px"><div id="divState"><?php echo $this->Form->input('state', array('label'=>'State:','div'=>false,'type'=>'select','options'=>array('ACT'=>'ACT','NT'=>'NT','NSW'=>'NSW','QLD'=>'QLD','SA'=>'SA','TAS'=>'TAS','VIC'=>'VIC','WA'=>'WA'),'default'=>'VIC'));?></div></td>
