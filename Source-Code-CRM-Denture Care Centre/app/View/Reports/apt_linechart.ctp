...
$(function () {
 ...
 var options = {
            ...
            title: {
                text: 'Monthly Appointment Amount (2012)'
            },
            subtitle: {
...
$.ajax({
		type: "POST",
        url: "/review/reports/getAptBarData",
        ...
        success: function(data) {   
         ...
         <div>
         <?php echo $this->Form->create('Report', array('action'=>'aptLinechart')); ?>
         <?php
         $start='';
         ...
         ?>
         <a href="/review/reports/aptLinechart" target="_blank" class='bigger btn btn-success'>Open in a new tab</a>
         <?php
         echo $this->Form->end();
         ?>
