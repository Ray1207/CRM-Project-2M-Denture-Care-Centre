...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            title: {
                text: 'Patient type shares at Denture Care Centre, 2012'
            },
            tooltip: {
                formatter: function() {
 ...
 <body style="padding-left:0px;">  
         ...
         <div>
         <?php echo $this->Form->create('Report', array('action'=>'pieChart')); ?>
         <?php
         $start='';
         ...
         ?>
         <a href="/review/reports/pieChart" target="_blank" class='bigger btn btn-success'>Open in a new tab</a>
         <?php
         echo $this->Form->end();
         ?>
