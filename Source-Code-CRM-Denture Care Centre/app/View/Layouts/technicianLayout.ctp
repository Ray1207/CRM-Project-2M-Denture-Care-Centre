...
<head>
      ...
      <?php
	     ...
	     echo $this->Html->css ('techniciansLayout');
...
<body id="container" onload="loadType()">
 ...
 <div id="top">
    <?php echo $this->Html->image ('SystemLogo.png', array ('alt'=>'Denture Care Centre Management System', 'id'=>'systemLogo', 'border'=>'0', 'url'=> array ('controller'=>'users'))); ?>
