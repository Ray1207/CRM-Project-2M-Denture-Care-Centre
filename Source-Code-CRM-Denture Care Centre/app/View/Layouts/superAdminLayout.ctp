...
<head>
      ...
      <?php
	     ...
	     echo $this->Html->css ('superAdminLayout');
      ?>
      <?php
...
<body id="container" onload="loadType()">
 ...
 <div id="sideMenuBar">
     ...
     <p><?php echo $this->Html->link ('Patient',array ('controller'=>'patients','action'=>'searchPatient')); ?> </p>
      ...
      <?php echo $this->Html->image ('Technician.jpg', array ('alt'=>'Staff', 'id'=>'technician', 'border'=>'0','url'=> array ('controller'=>'users','action'=>'searchAdmin'))); ?>    
    <p><?php echo $this->Html->link ('Staff',array ('controller'=>'users','action'=>'searchAdmin')); ?> </p>
     ...
     <?php echo $this->Html->image ('Admin.png', array ('alt'=>'System Administration', 'id'=>'admin', 'border'=>'0','url'=> array ('controller'=>'Systems','action'=>'index'))); ?>    
